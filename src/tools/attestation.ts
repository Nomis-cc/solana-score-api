...
export async function getCredentialPda(address: string) {
...
export async function getSchemaPda(address: string) {
...
export function getCreateCredentialTransaction(
  props: Omit<CreateCredentialInput, 'name'>,
) {
  const ix = transformInstructionObject(
    getCreateCredentialInstruction({
      ...props,
      name: CREDENTIAL_NAME,
    }),
...
export function getCreateSchemaTransaction(
  props: Omit<
    CreateSchemaInput,
...
export function getCreateAttestationTransaction(
  ...
  return transactionBuilder().add(transformInstructionObject(ix));
}

export function transformInstructionObject(
  obj:
